title: Move More 2020 Anti-Challenge
category: Move More 2020 Anti-Challenge
slug: move-more-2020
date: 12-31-2019

It is more important than ever for us to keep ourselves healthy and take care of our mental health by doing meditation, strength and balance exercises, hydration, and stretches. What if you could incorporate these into your routine so that it became a habit -- an ingrained activity that happens without you having to decide or having to remember to do it?
...
Have you already tried to incorporate these things into your day but found it challenging? 

Change is *hard* when it:  

- Feels overwhelming
- Relies on you remembering to do it
- Disrupts your existing habits
...
- Strengthen your quads while you wash your hands
...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--horizontal" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:9px; border-width:1px; border-color:#C0CCD9; border-style:solid;">
      <form id="sib-form" method="POST" action="https://85c76102.sibforms.com/serve/MUIEACQhtDhaJioHOa5_9uXApF5jZFvqfT7VIcFTUc9c5OUosisH0t4y3imQucJGZFdEgvQfRFCwn2PPfbgUnKiDDGQBG9raBbBdeH2RVePp0iW-550z55n9tJ4Oa8pHXiY-yjEPJMoJ9l9nc3AMqCaXthF-DVbOy_TZZD1GJFEPzKvgddqG4X-Rxb16JnEKko5mjV4TxR5Em01N"
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent; border-width:px;">
            <div class="sib-text-form-block">
              <p>Get life-changing, tiny changes delivered to your inbox twice a week.</p>
            </div>
          </div>
        </div>
        <div style="padding: 8px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              ...
              <label class="entry__specification" style="font-size:12px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#8390A4; border-width:px;">
                Provide your email address to subscribe. For e.g abc@xyz.com. Your email will not be shared with anyone outside Datasmithing.
              </label>
            </div>
          </div>
        </div>
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="text-align: center">
            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-size:16px; text-align:center; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#FFFFFF; background-color:#3030bd; border-radius:3px; border-width:0px;"
